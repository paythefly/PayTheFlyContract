/**
 * Manual Upgrade PayTheFlyPro contracts on BSC Mainnet
 ...
 *
 * Usage:
 *   npx hardhat run scripts/deploy/upgradeBSCManual.js --network bsc
 */
...
async function main() {
    ...
    console.log("========================================");
    console.log("PayTheFlyPro Manual Upgrade - BSC Mainnet");
    console.log("========================================");
